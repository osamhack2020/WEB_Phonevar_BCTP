...
* __사용자 앱 / 관리자 앱__
  * 사용자 등록<br>
  ...
  <table>
		  <tr>  
				  ...
				  <td>데이터 위조를 방지하기 위해 서버 데이터베이스에 입력된 사용자만 스마트폰 등록을 할 수 있도록 했습니다.<br>기본적인 인적사항은 국방부 데이터와 연계한다고 가정했습니다.</td>  
		  </tr>
  </table>	
  ...
  * 사용기록 작성<br>
	  ...
	  * __기준 3__
	  ![Alt text](/IMG/3.png)
  * 스마트폰 제출 푸시 알림
  | <img src = "./IMG/app_user_push.png" width="300"> | 데이터 위조를 방지하기 위해 서버 데이터베이스에 입력된 사용자만 스마트폰 등록을 할 수 있도록 했습니다.<br>기본적인 인적사항은 국방부 데이터와 연계한다고 가정했습니다. |
|--|--|
  * 사용기록 서버 전송
